export const gardenCoreAbi = [
  ...
  { "inputs": [{"internalType":"uint16","name":"plotId","type":"uint16"},{"internalType":"uint8","name":"cellId","type":"uint8"},{"internalType":"uint16","name":"seedType","type":"uint16"}], "name":"plant", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
  { "inputs": [{"internalType":"uint16","name":"plotId","type":"uint16"},{"internalType":"uint8","name":"cellId","type":"uint8"}], "name":"harvest", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
  { "inputs": [{"internalType":"uint16","name":"seedType","type":"uint16"},{"internalType":"uint256","name":"qty","type":"uint256"}], "name":"sellCrops", "outputs": [], "stateMutability": "nonpayable", "type": "function" },
  { "inputs": [{"internalType":"address","name":"player","type":"address"},{"internalType":"uint16","name":"plotId","type":"uint16"}], "name":"getPlotCells", "outputs": [{"internalType":"uint256[12]","name":"","type":"uint256[12]"}], "stateMutability":"view", "type":"function" },
